...
@DisplayName("JGitService#delete")
class JGitServiceDeleteTest extends AbstractJGitServiceTest {
  ...
  void testDeleteNoFile() {
    ...
    Mockito.verify(rmCommand, Mockito.never()).call();
  ...
  @SneakyThrows
  void testDeleteRepositoryNotExist() {
  ...
  @Test
  @DisplayName("should throw GitCommandException if unknown GitApiException occurred on rm command")
  @SneakyThrows
  void testDelete_addCommandException() {
  ...
  @SneakyThrows
  void testDelete_statusCommandUnknownGitApiException() {
    var ex = new GitAPIException("unknown exception") {
    };
  ...
  @SneakyThrows
  void testDelete_logCommandUnknownGitApiException() {
    var ex = new GitAPIException("unknown exception") {
    };
  ...
  @SneakyThrows
  void testDelete_commitCommandUnknownGitApiException() {
    var ex = new GitAPIException("unknown exception") {
    };
  ...
  @SneakyThrows
  void testDelete_remoteAddCommandUnknownGitApiException() {
    var ex = new GitAPIException("unknown exception") {
    };
  ...
  @SneakyThrows
  void testDelete_remoteAddInvalidURI() {
  ...
  @SneakyThrows
  void testDelete_pushCommandUnknownGitApiException() {
    var ex = new GitAPIException("unknown exception") {
    };

...
public class UserImportServiceImpl implements UserImportService {
  ...
  @Override
  @NonNull
  public CephFileInfoDto storeFile(@NonNull MultipartFile file,
  ...
  @Override
  public void delete(@NonNull String cephKey) {
    try {
  ...
  @Override
  @NonNull
  public CephFileDto downloadFile(@NonNull String cephKey) {

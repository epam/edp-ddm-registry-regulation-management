...
image::low-level-component-structure.svg[registry-regulation-management low-level-component-structure]
...
image::module-structure.svg[registry-regulation-management multi module component structure]
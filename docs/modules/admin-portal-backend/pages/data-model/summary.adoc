...
[plantuml, admin-portal-backend db-tables-management-er, svg]
----
include::partial$data-model/db-tables-management-er.puml[]
----
...
image::data-model/tables-management-datamodel-filestructure.svg[]
...
image::data-model/tables-management-component-structure.svg[]
...
[source,json]
----
include::partial$data-model/schema/DataModelSnapshotSchema-table.json[]
----

==== Table Document example
[source,json]
----
include::partial$data-model/schema/examples/table-example.json[]
----

==== Role permissions JsonSchema
[source,json]
----
include::partial$data-model/schema/DataModelSnapshotSchema-role-permission.json[]
----

==== Role permissions document example
[source,json]
----
include::partial$data-model/schema/examples/role-permission-example.json[]
----

...
Повертає список всіх бізнес-процесів регламенту, їх назви, системні назви та дати створення та останнього оновлення бізнес-процесів.

Діаграма послідовності отримання списку доступних бізнес-процесів:

[plantuml]
----
include::partial$business-processes/get-business-process-list.puml[]
----
...
** XPath дати останнього оновлення бізнес-процесу - `**__/bpmn:definitions/@dates:updated__**`
...
<bpmn:definitions
    ...
    rrm:updated="2022-10-15T07:11:54.588Z">

...
public class GerritServiceImpl implements GerritService {
  ...
  @Override
  public void submitChanges(String changeId) throws RestApiException {
  ...
  @Override
  public Boolean review(String changeId) throws RestApiException {
  ...
  @Override
  public void declineChange(String changeId) throws RestApiException {

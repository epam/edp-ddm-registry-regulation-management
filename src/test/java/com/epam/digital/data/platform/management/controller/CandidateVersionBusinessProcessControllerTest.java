...
public class CandidateVersionBusinessProcessControllerTest {
  ...
  private static final String BUSINESS_PROCESS_CONTENT =
      "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
          ...
          +
          "  <bpmn:process id=\"" + BUSINESS_PROCESS_ID + "\" name=\"" + BUSINESS_PROCESS_NAME
          + "\" isExecutable=\"true\">\n" +
  ...
  public void getBusinessProcess() {
    Mockito.when(
            businessProcessService.getProcessContent(BUSINESS_PROCESS_ID, CANDIDATE_VERSION_ID))
  ...
  public void createBusinessProcess() {
    ...
    Mockito.verify(businessProcessService)
        .createProcess(BUSINESS_PROCESS_ID, BUSINESS_PROCESS_CONTENT, CANDIDATE_VERSION_ID);
  }
  ...
  public void updateBusinessProcess() {
    ...
    Mockito.verify(businessProcessService)
        .updateProcess(BUSINESS_PROCESS_CONTENT, BUSINESS_PROCESS_ID, CANDIDATE_VERSION_ID);
  }
